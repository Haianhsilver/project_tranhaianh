...
class AdminPanelSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('users')->insert([
            'id' => 07012000,
            'name' => 'Trần Hải Anh',
            'email' => 'haianhsan123@gmail.com',
            'password' => '$2y$12$d6/tlQ6bSHcQ0GrLdLOmzO1PF2w7epv37EkP9LOXiaIkgWycVvsSa', // haianhkudo123
            'birth' => '2000-01-07 00:00:00',
            'address' => 'VN',
            'gender' => 1,
            'user_status' => 15,
            'phone' => '0231129391',
            'permission' => 16,
            'clinic_id' => 24060214514076,
            'specialties_id' => 24021016284430,
            'examination_price' => 0,
            'description' => '<p>6 năm kinh nghiệm</p>',
            'created_at' => now(),
            'updated_at' => now(),
